 ...
 */
namespace MageWorx\SearchSuiteAutocomplete\Controller\Advanced;
 ...
 * Search result.
 */
class Results extends \Magento\Framework\App\Action\Action implements HttpGetActionInterface, HttpPostActionInterface
{
    /**
    ...
    public function execute()
    {
        ...
        if(array_key_exists('sku', $this->getRequest()->getParams())){
            $this->getRequest()->setParam(QueryFactory::QUERY_VAR_NAME,$this->getRequest()->getParams()['sku']);
        }
        ...
        if ($queryText != '') {
            ...
            unset($getAdditionalRequestParameters['sku']);
